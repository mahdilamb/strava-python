...
class SegmentsApi(object):
    ...
    def explore_segments_with_http_info(self, bounds, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('bounds' not in params or
                                                       params['bounds'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bounds` when calling `explore_segments`")  # noqa: E501

        if self.api_client.client_side_validation and ('bounds' in params and
                                            len(params['bounds']) > 4):
        ...
        if self.api_client.client_side_validation and ('min_cat' in params and params['min_cat'] > 5):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('min_cat' in params and params['min_cat'] < 0):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('max_cat' in params and params['max_cat'] > 5):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('max_cat' in params and params['max_cat'] < 0):  # noqa: E501
    ...
    def star_segment_with_http_info(self, id, starred, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('starred' not in params or
                                                       params['starred'] is None):  # noqa: E501
