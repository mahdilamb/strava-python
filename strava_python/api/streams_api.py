...
class StreamsApi(object):
    ...
    def get_activity_streams_with_http_info(self, id, keys, key_by_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('keys' not in params or
                                                       params['keys'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('key_by_type' not in params or
                                                       params['key_by_type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `key_by_type` when calling `get_activity_streams`")  # noqa: E501

        if self.api_client.client_side_validation and ('keys' in params and
                                            len(params['keys']) < 1):
