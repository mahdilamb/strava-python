...
class DistanceStream(BaseModel):
    """
    DistanceStream
    """
    ...
    data: Optional[conlist(Union[StrictFloat, StrictInt])] = Field(None, description="The sequence of distance values for this stream, in meters")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DistanceStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DistanceStream:
        """Create an instance of DistanceStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DistanceStream.parse_obj(obj)

        _obj = DistanceStream.parse_obj({
