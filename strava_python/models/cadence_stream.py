...
class CadenceStream(BaseModel):
    ...
    data: Optional[conlist(StrictInt)] = Field(None, description="The sequence of cadence values for this stream, in rotations per minute")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CadenceStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CadenceStream:
        """Create an instance of CadenceStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CadenceStream.parse_obj(obj)

        _obj = CadenceStream.parse_obj({
