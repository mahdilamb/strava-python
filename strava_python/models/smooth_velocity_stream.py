...
class SmoothVelocityStream(BaseModel):
    """
    ...
    data: Optional[conlist(Union[StrictFloat, StrictInt])] = Field(None, description="The sequence of velocity values for this stream, in meters per second")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmoothVelocityStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmoothVelocityStream:
        """Create an instance of SmoothVelocityStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmoothVelocityStream.parse_obj(obj)

        _obj = SmoothVelocityStream.parse_obj({
