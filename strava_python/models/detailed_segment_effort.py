...
class DetailedSegmentEffort(object):
    ...
    def __init__(self, name=None, activity=None, athlete=None, moving_time=None, start_index=None, end_index=None, average_cadence=None, average_watts=None, device_watts=None, average_heartrate=None, max_heartrate=None, segment=None, kom_rank=None, pr_rank=None, hidden=None, _configuration=None):  # noqa: E501
