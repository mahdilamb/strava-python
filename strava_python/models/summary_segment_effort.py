...
class SummarySegmentEffort(object):
    ...
    def __init__(self, id=None, activity_id=None, elapsed_time=None, start_date=None, start_date_local=None, distance=None, is_kom=None, _configuration=None):  # noqa: E501
