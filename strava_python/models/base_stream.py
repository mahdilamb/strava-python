...
class BaseStream(BaseModel):
    ...
    __properties = ["original_size", "resolution", "series_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseStream:
        """Create an instance of BaseStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseStream.parse_obj(obj)

        _obj = BaseStream.parse_obj({
