...
class HeartrateStream(BaseModel):
    """
    HeartrateStream
    """
    ...
    data: Optional[conlist(StrictInt)] = Field(None, description="The sequence of heart rate values for this stream, in beats per minute")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HeartrateStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HeartrateStream:
        """Create an instance of HeartrateStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HeartrateStream.parse_obj(obj)

        _obj = HeartrateStream.parse_obj({
