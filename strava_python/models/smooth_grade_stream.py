...
class SmoothGradeStream(BaseModel):
    """
    SmoothGradeStream
    """
    ...
    data: Optional[conlist(Union[StrictFloat, StrictInt])] = Field(None, description="The sequence of grade values for this stream, as percents of a grade")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmoothGradeStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmoothGradeStream:
        """Create an instance of SmoothGradeStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SmoothGradeStream.parse_obj(obj)

        _obj = SmoothGradeStream.parse_obj({
