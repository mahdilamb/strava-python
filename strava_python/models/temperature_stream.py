...
class TemperatureStream(BaseModel):
    """
    TemperatureStream
    """
    ...
    data: Optional[conlist(StrictInt)] = Field(None, description="The sequence of temperature values for this stream, in celsius degrees")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemperatureStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemperatureStream:
        """Create an instance of TemperatureStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemperatureStream.parse_obj(obj)

        _obj = TemperatureStream.parse_obj({
