...
class ActivityTotal(object):
    ...
    def __init__(self, count=None, distance=None, moving_time=None, elapsed_time=None, elevation_gain=None, achievement_count=None, _configuration=None):  # noqa: E501
