...
class MovingStream(BaseModel):
    ...
    data: Optional[conlist(StrictBool)] = Field(None, description="The sequence of moving values for this stream, as boolean values")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MovingStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MovingStream:
        """Create an instance of MovingStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MovingStream.parse_obj(obj)

        _obj = MovingStream.parse_obj({
