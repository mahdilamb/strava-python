...
class SummaryClub(BaseModel):
    ...
    __properties = ["id", "resource_state", "name", "profile_medium", "cover_photo", "cover_photo_small", "sport_type", "activity_types", "city", "state", "country", "private", "member_count", "featured", "verified", "url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SummaryClub:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SummaryClub:
        """Create an instance of SummaryClub from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SummaryClub.parse_obj(obj)

        _obj = SummaryClub.parse_obj({
            "id": obj.get("id"),
