...
class SummaryClub(object):
    ...
    def __init__(self, profile_medium=None, cover_photo=None, cover_photo_small=None, sport_type=None, activity_types=None, city=None, state=None, country=None, private=None, member_count=None, featured=None, verified=None, url=None, _configuration=None):  # noqa: E501
