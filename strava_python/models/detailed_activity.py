...
class DetailedActivity(object):
    ...
    def __init__(self, description=None, photos=None, gear=None, calories=None, segment_efforts=None, device_name=None, embed_token=None, splits_metric=None, splits_standard=None, laps=None, best_efforts=None, _configuration=None):  # noqa: E501
