...
class DetailedActivity(BaseModel):
    ...
    start_latlng: Optional[conlist(Union[StrictFloat, StrictInt], max_length=2, min_length=2)] = Field(None, description="A pair of latitude/longitude coordinates, represented as an array of 2 floating point numbers.")
    end_latlng: Optional[conlist(Union[StrictFloat, StrictInt], max_length=2, min_length=2)] = Field(None, description="A pair of latitude/longitude coordinates, represented as an array of 2 floating point numbers.")
