...
class ActivityZone(object):
    ...
    def __init__(self, score=None, distribution_buckets=None, type=None, sensor_based=None, points=None, custom_zones=None, max=None, _configuration=None):  # noqa: E501
