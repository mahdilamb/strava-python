...
class Split(object):
    ...
    def __init__(self, average_speed=None, distance=None, elapsed_time=None, elevation_difference=None, pace_zone=None, moving_time=None, split=None, _configuration=None):  # noqa: E501
