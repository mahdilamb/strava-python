...
class DetailedAthlete(object):
    ...
    def __init__(self, follower_count=None, friend_count=None, measurement_preference=None, ftp=None, weight=None, clubs=None, bikes=None, shoes=None, _configuration=None):  # noqa: E501
