...
class StreamSet(object):
    ...
    def __init__(self, time=None, distance=None, latlng=None, altitude=None, velocity_smooth=None, heartrate=None, cadence=None, watts=None, temp=None, moving=None, grade_smooth=None, _configuration=None):  # noqa: E501
