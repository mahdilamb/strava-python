...
class Route(object):
    ...
    def __init__(self, athlete=None, description=None, distance=None, elevation_gain=None, id=None, id_str=None, map=None, name=None, private=None, starred=None, timestamp=None, type=None, sub_type=None, created_at=None, updated_at=None, estimated_moving_time=None, segments=None, _configuration=None):  # noqa: E501
