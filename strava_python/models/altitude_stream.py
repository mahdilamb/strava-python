...
class AltitudeStream(BaseModel):
    """
    AltitudeStream
    """
    ...
    data: Optional[conlist(Union[StrictFloat, StrictInt])] = Field(None, description="The sequence of altitude values for this stream, in meters")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AltitudeStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AltitudeStream:
        """Create an instance of AltitudeStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AltitudeStream.parse_obj(obj)

        _obj = AltitudeStream.parse_obj({
