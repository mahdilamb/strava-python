...
class PhotosSummary(BaseModel):
    ...
    PhotosSummary
    """
    count: Optional[StrictInt] = Field(None, description="The number of photos")
    primary: Optional[PhotosSummaryPrimary] = None
    __properties = ["count", "primary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhotosSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhotosSummary:
        """Create an instance of PhotosSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhotosSummary.parse_obj(obj)

        _obj = PhotosSummary.parse_obj({
            "count": obj.get("count"),
            "primary": PhotosSummaryPrimary.from_dict(obj.get("primary")) if obj.get("primary") is not None else None
        })
        return _obj
