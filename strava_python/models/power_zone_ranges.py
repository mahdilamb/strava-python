...
class PowerZoneRanges(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PowerZoneRanges:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PowerZoneRanges:
        """Create an instance of PowerZoneRanges from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PowerZoneRanges.parse_obj(obj)

        _obj = PowerZoneRanges.parse_obj({
