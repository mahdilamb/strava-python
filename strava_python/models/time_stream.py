...
class TimeStream(BaseModel):
    ...
    data: Optional[conlist(StrictInt)] = Field(None, description="The sequence of time values for this stream, in seconds")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeStream:
        """Create an instance of TimeStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeStream.parse_obj(obj)

        _obj = TimeStream.parse_obj({
