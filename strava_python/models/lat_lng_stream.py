...
class LatLngStream(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LatLngStream:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LatLngStream:
        """Create an instance of LatLngStream from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LatLngStream.parse_obj(obj)

        _obj = LatLngStream.parse_obj({
