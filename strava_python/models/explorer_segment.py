...
class ExplorerSegment(object):
    ...
    def __init__(self, id=None, name=None, climb_category=None, climb_category_desc=None, avg_grade=None, start_latlng=None, end_latlng=None, elev_difference=None, distance=None, points=None, _configuration=None):  # noqa: E501
    ...
    def climb_category(self, climb_category):
        ...
        if (self._configuration.client_side_validation and
                climb_category is not None and climb_category > 5):  # noqa: E501
            raise ValueError("Invalid value for `climb_category`, must be a value less than or equal to `5`")  # noqa: E501
        if (self._configuration.client_side_validation and
                climb_category is not None and climb_category < 0):  # noqa: E501
    ...
    def climb_category_desc(self, climb_category_desc):
        ...
        if (self._configuration.client_side_validation and
                climb_category_desc not in allowed_values):
            raise ValueError(
