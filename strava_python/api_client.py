...
import strava_python.models
from strava_python import rest
from strava_python.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(strava_python.models, klass)
