...
from strava_python.models.temperature_stream import TemperatureStream  # noqa: E501
...
class TestTemperatureStream(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TemperatureStream`
        """
        model = strava_python.models.temperature_stream.TemperatureStream()  # noqa: E501
        if include_optional :
