...
from strava_python.models.heartrate_stream import HeartrateStream  # noqa: E501
...
class TestHeartrateStream(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `HeartrateStream`
        """
        model = strava_python.models.heartrate_stream.HeartrateStream()  # noqa: E501
        if include_optional :
