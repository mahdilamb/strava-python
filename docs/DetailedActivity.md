...
detailed_activity_instance = DetailedActivity.from_json(json)
# print the JSON string representation of the object
print DetailedActivity.to_json()

# convert the object into a dict
detailed_activity_dict = detailed_activity_instance.to_dict()
# create an instance of DetailedActivity from a dict
detailed_activity_form_dict = detailed_activity.from_dict(detailed_activity_dict)
```
